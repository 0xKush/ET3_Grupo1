...
class GUEST_Controller extends BaseController {
    ...
    public function add()
    {
        ...
        if (isset($_POST["submit"])) {
            ...
            try {
                if(!$this->guestModel->friendExists($_POST["event"], $_POST["member"], $_POST[secondarymember"member"]) && !empty($_POST["event"]) && !empty($_POST["member"]) && !empty($_POST["secondarymember"])){
